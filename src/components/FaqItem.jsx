  ...
  return (
    <div className="relative z-2 mb-16">
      <div
        ...
        onClick={() => {
          {
            /*for making questions active*/
          }
          setActiveId(activeId === item.id ? null : item.id);
        }}
      >
        <div className="flex-1">
          {/*this div for 01,02,03 bullet numbers*/}
          ...
          >
            {/*for actual questions importing*/}
            {item.question}
          </div>
        </div>

        {/*div for plus icon in questions*/}
      ...
      {/*for sliding down effect and opening of faq answers*/}
      <SlideDown>
        {activeId === item.id && (
      ...
      {/*for box effect on answers when they are pulled down*/}
      <div
        className={clsx(
