...
// testimonialItem.jsx (SINGLE ITEM)
// Receives one testimonial at a time and displays it.

const TestimonialItem = ({ item, containerClassName }) => {
  // here above as containerClassName we are defining props and children
  return (
    <div
      // here were are arranging those testimonials in two lines and making css and hprizontal lines
      className={clsx(
